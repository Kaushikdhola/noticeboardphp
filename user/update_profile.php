...
$query="update user set name='$n',mobile_no='$mob',gender='$gen',dob='$dob' where email='".$_SESSION['user']."'";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input class="form-control" type="text" value="<?php echo $res['mobile_no'];?>"  name="mob"/></td>
				</tr>
