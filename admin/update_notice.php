...
if(isset($update))
{
mysqli_query($conn,"update notice set subject='$sub',des='$details' where id='".$_GET['id']."'");
...
$q=mysqli_query($conn,"select * from notice where id='".$_GET['id']."'");
...
<form method="post">
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<textarea name="details" class="form-control"><?php echo $res['des']; ?></textarea></div>
	</div>
